      ...
      <div className="max-w-2xl mx-auto text-center">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
            The project you&apos;re looking for doesn&apos;t exist. It may have been removed, renamed, or you may have followed an incorrect link.
          </p>
        </div>
        ...
        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
          ...
          <ul className="text-left text-gray-600 dark:text-gray-400 space-y-2">
            <li className="flex items-start gap-2">
              ...
              <span>Explore all my projects to see my work and case studies</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-600 dark:text-blue-400 mt-1">•</span>
            ...
            <li className="flex items-start gap-2">
              <span className="text-blue-600 dark:text-blue-400 mt-1">•</span>
              <span>Visit the homepage to explore other sections of my portfolio</span>
            </li>
          </ul>
        </div>
      </div>
